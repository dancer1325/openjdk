...
| Effort | M | 
| Duration | S | 
| Relates to | JEP 301: Enhanced Enums](301) | 
|  | JEP 323: Local-Variable Syntax for Lambda Parameters](323) | 
| Reviewed by | Alex Buckley, Mark Reinhold | 
| Endorsed by | Mark Reinhold | 
| Created | 2016/03/08 15:37 | 
| Updated | 2022/09/28 16:49 | 
| Issue | 8151454](https://bugs.openjdk.org/browse/JDK-8151454) | 
...
Like any other language feature, local variable type inference can be used to write both clear and unclear code; ultimately the responsibility for writing clear code lies with the user. See thestyle guidelines](https://openjdk.org/projects/amber/guides/lvti-style-guide)for using`var`, and theFrequently Asked Questions](https://openjdk.org/projects/amber/guides/lvti-faq).
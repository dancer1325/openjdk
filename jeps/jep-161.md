...
| Release | 8 | 
| JSRs | 3 MR](https://jcp.org/en/jsr/detail?id=3),160 MR](https://jcp.org/en/jsr/detail?id=160),337](https://jcp.org/en/jsr/detail?id=337) | 
| Discussion | jdk8 dash dev at openjdk dot java dot net | 
| Effort | M | 
| Duration | M | 
| Depends | JEP 138: Autoconf-Based Build System](138) | 
| Created | 2012/08/15 20:00 | 
| Updated | 2023/01/26 23:37 | 
| Issue | 8046151](https://bugs.openjdk.org/browse/JDK-8046151) | 
...
More broadly, this feature is intended to enable the migration of applications currently built on top of the Java MEConnected Device Configuration (CDC)](http://en.wikipedia.org/wiki/Connected_Device_Configuration)to appropriate Profiles of the Java SE Platform, part of the long-term effort to converge CDC with Java SE.
...
The JDK build system can currently produce a full Java Runtime Environment (JRE) or a complete Java Development Kit (JDK), which is the full JRE plus a set of development tools. We plan to enhance the new build system described inJEP 138](https://bugs.openjdk.org/browse/JDK-8046128)to optionally produce the three additional Compact target JRE images.

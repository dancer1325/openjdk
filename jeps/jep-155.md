...
| Blocks | JEP 103: Parallel Array Sorting](103) | 
| Depends | JEP 109: Enhance Core Libraries with Lambda](109) | 
|  | JEP 126: Lambda Expressions & Virtual Extension Methods](126) | 
| Endorsed by | Brian Goetz | 
| Created | 2012/04/21 20:00 | 
| Updated | 2017/08/13 17:12 | 
| Issue | 8046145](https://bugs.openjdk.org/browse/JDK-8046145) | 
...
- 
Added features (and possibly added APIs) that make`ConcurrentHashMaps`and classes built from them more useful as caches. These include methods to compute values for keys when they are not present, as well as improved support for scanning and possibly evicting entries, as well as better support for maps with large numbers of elements.

- 
Added functionality and improved performance for`ForkJoinPool`s that allow them to be used more effectively in the increasingly wider range of applications that users desire. New features include support for completion-based designs that are often most appropriate for IO-bound usages, among others.

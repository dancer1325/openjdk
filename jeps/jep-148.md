...
| Updated | 2017/06/14 21:47 | 
| Issue | 8046138](https://bugs.openjdk.org/browse/JDK-8046138) | 
...
An earlier effort to reduce the size of`libjvm.so`was undertaken when implementing theJava Kernel](http://www.oracle.com/technetwork/java/javase/kernel-135055.html). The kernel VM removed many larger components such as extra garbage collectors, the C2 JIT, and most of JVMTI.

...
| Created | 2024/06/21 08:36 | 
| Updated | 2025/08/14 08:02 | 
| Issue | 8334712](https://bugs.openjdk.org/browse/JDK-8334712) | 
...
TheClass-File API](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/classfile/package-summary.html)was originally proposed as a preview feature byJEP 457](https://openjdk.org/jeps/457)inJDK 22](https://openjdk.org/projects/jdk/22/)and refined byJEP 466](https://openjdk.org/jeps/466)inJDK 23](https://openjdk.org/projects/jdk/23/). We here propose to finalize the API inJDK 24](https://openjdk.org/projects/jdk/24/)with minor changes, detailedbelow](#Changes), based on further experience and feedback.

## Goals

- 
Provide an API for processing class files that tracks the`class`file format defined by theJava Virtual Machine Specification](https://docs.oracle.com/javase/specs/jvms/se23/html/jvms-4.html).
...
- 
It is not a goal to extend theCore Reflection API](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/lang/reflect/package-summary.html)to give access to the bytecode of loaded classes.
...
We have adopted the following design goals and principles for theClass-File API](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/classfile/package-summary.html).
...
- 
Each kind of compound element has a corresponding*builder*which has specific building methods (e.g.,`ClassBuilder::withMethod`) and is also a`Consumer`](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/util/function/Consumer.html)of the appropriate element type.
...
Enum values renamed:
  ...
  - All values of`TypeKind`renamed to`UPPER_SNAKE_CASE`](https://bugs.openjdk.org/browse/JDK-8339116)

- 
Fields moved and renamed:

  - `AttributesProcessingOption.DROP_UNSTABLE_ATRIBUTES`→`DROP_UNSTABLE_ATTRIBUTES`](https://bugs.openjdk.org/browse/JDK-8340201)
  - `ClassFile.AEV_*`→`AnnotationValue.TAG_*`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `ClassFile.CRT_*`→`CharacterRange.FLAG_*`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `ClassFile.TAG_*`→`PoolEntry.TAG_*`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `ClassFile.TAT_*`→`TypeAnnotation.TARGET_*`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `ClassFile.VT_*`→`StackMapFrameInfo.VerificationTypeInfo.ITEM_*`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `StackMapFrameInfo.SimpleVerificationTypeInfo.ITEM_*`→`*`](https://bugs.openjdk.org/browse/JDK-8339266)

- 
Fields removed as unnecessary exposure or as redundant:

  - `ClassFile.DEFAULT_CLASS_FLAGS`](https://bugs.openjdk.org/browse/JDK-8339266)
  - `ClassFile.NOP...JSR_W`opcodes are accessible as`Opcode::bytecode()`](https://bugs.openjdk.org/browse/JDK-8339266)

- 
Methods added:

  - `AnnotationValue.OfConstant::resolvedValue()`](https://bugs.openjdk.org/browse/JDK-8336353)
  - `TypeKind::upperBound()`](https://bugs.openjdk.org/browse/JDK-8339116)

- 
Method overloads added:

  - `CodeBuilder::loadConstant(int)`](https://bugs.openjdk.org/browse/JDK-8339256)
  - `CodeBuilder::loadConstant(long)`](https://bugs.openjdk.org/browse/JDK-8339256)
  - `CodeBuilder::loadConstant(float)`](https://bugs.openjdk.org/browse/JDK-8339256)
  - `CodeBuilder::loadConstant(double)`](https://bugs.openjdk.org/browse/JDK-8339256)

- 
Methods renamed:

  - `ClassFile::transform`→`transformClass`](https://bugs.openjdk.org/browse/JDK-8335359)
  - `CodeBuilder::if_null`→`ifnull`](https://bugs.openjdk.org/browse/JDK-8335111)
  - `CodeBuilder::if_nonnull`→`ifnonnull`](https://bugs.openjdk.org/browse/JDK-8335111)
  - `CompoundElement::forEachElement`→`forEach`](https://bugs.openjdk.org/browse/JDK-8336034)

- 
Methods moved from one interface to another:

  - `CodeModel::maxStack`→ CodeAttribute](https://bugs.openjdk.org/browse/JDK-8337238)
  - `CodeModel::maxLocals`→ CodeAttribute](https://bugs.openjdk.org/browse/JDK-8337238)

- 
Methods return type changed:

  - `Attribute::attributeName`](https://bugs.openjdk.org/browse/JDK-8344203)
  - `CustomAttribute::attributeName`](https://bugs.openjdk.org/browse/JDK-8344203)

- 
Superinterface removed:

  - `TypeAnnotation`no longer extends`Annotation`](https://bugs.openjdk.org/browse/JDK-8336794)

- 
Interface signature changed:

  - `AttributeMapper<A>`→`AttributeMapper<A extends Attribute<A>>`](https://bugs.openjdk.org/browse/JDK-8338774)

- 
Interfaces removed as unnecessary exposure of implementation internals:

  - `ResolvedTransform`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `WritableElement`](https://bugs.openjdk.org/browse/JDK-8336586)

- 
Methods removed as unnecessary exposure of implementation internals or as redundant alternatives:

  - `AccessFlags::ofClass(AccessFlag ...)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `AccessFlags::ofClass(int)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `AccessFlags::ofField(AccessFlag ...)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `AccessFlags::ofField(int)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `AccessFlags::ofMethod(AccessFlag ...)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `AccessFlags::ofMethod(int)`](https://bugs.openjdk.org/browse/JDK-8337240)
  - `BufWriter::copyTo(byte[], int)`](https://bugs.openjdk.org/browse/JDK-8336586)
  - `BufWriter::writeBytes(BufWriter)`](https://bugs.openjdk.org/browse/JDK-8336586)
  - `BufWriter::writeListIndices(List<? extends PoolEntry>)`](https://bugs.openjdk.org/browse/JDK-8336586)
  - `ClassBuilder::original()`](https://bugs.openjdk.org/browse/JDK-8336354)
  - `ClassFileBuilder::canWriteDirect(ConstantPool)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `ClassFileTransform::resolve(B)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `ClassReader::readClassEntry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readMethodHandleEntry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readModuleEntry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readNameAndTypeEntry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readPackageEntry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readUtf8Entry(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassReader::readUtf8EntryOrNull(int)`](https://bugs.openjdk.org/browse/JDK-8334735)
  - `ClassTransform::resolve(ClassBuilder)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `CodeBuilder::loadConstant(Opcode, ConstantDesc)`](https://bugs.openjdk.org/browse/JDK-8339283)
  - `CodeBuilder::original()`](https://bugs.openjdk.org/browse/JDK-8336354)
  - `CodeRelabeler::relabel(Label, CodeBuilder)`](https://bugs.openjdk.org/browse/JDK-8334728)
  - `CodeTransform::resolve(CodeBuilder)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `CompoundElement::elements()`](https://bugs.openjdk.org/browse/JDK-8336034)
  - `ConstantPoolBuilder::annotationConstantValueEntry(ConstantDesc)`](https://bugs.openjdk.org/browse/JDK-8336353)
  - `ConstantPoolBuilder::writeBootstrapMethods(BufWriter)`](https://bugs.openjdk.org/browse/JDK-8334728)
  - `FieldBuilder::original()`](https://bugs.openjdk.org/browse/JDK-8336354)
  - `FieldTransform::resolve(FieldBuilder)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `MethodBuilder::original()`](https://bugs.openjdk.org/browse/JDK-8336354)
  - `MethodTransform::resolve(MethodBuilder)`](https://bugs.openjdk.org/browse/JDK-8336027)
  - `ModuleAttributeBuilder::build()`](https://bugs.openjdk.org/browse/JDK-8334728)
  - `Opcode::constantValue()`](https://bugs.openjdk.org/browse/JDK-8339287)
  - `Opcode::isUnconditionalBranch()`](https://bugs.openjdk.org/browse/JDK-8339287)
  - `Opcode::primaryTypeKind()`](https://bugs.openjdk.org/browse/JDK-8339287)
  - `Opcode::secondaryTypeKind()`](https://bugs.openjdk.org/browse/JDK-8339287)
  - `Opcode::slot()`](https://bugs.openjdk.org/browse/JDK-8339287)
  - `TypeKind::descriptor()`](https://bugs.openjdk.org/browse/JDK-8339116)
  - `TypeKind::typeName()`](https://bugs.openjdk.org/browse/JDK-8339116)

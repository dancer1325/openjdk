...
| Issue | 8223220](https://bugs.openjdk.org/browse/JDK-8223220) | 
...
- A technology by which JVMCI and Compiler can be compiled into a shared library that implements the JNIInvocation API](https://docs.oracle.com/javase/10/docs/specs/jni/invocation.html)

...
| Created | 2014/06/12 05:55 | 
| Updated | 2016/06/07 23:48 | 
| Issue | 8046661](https://bugs.openjdk.org/browse/JDK-8046661) | 
...
The CPU profiler has a couple of shortcomings which are described in some detail inhttp://www.brendangregg.com/blog/2014-06-09/java-cpu-sampling-using-hprof.html](http://www.brendangregg.com/blog/2014-06-09/java-cpu-sampling-using-hprof.html)and elsewhere. There are other tools that provide better functionality with fewer problems. Among them are Java VisualVM and Java Flight Recorder, which are bundled with the JDK, as well as a number of third-party profilers.

### Demonstration code

The`hprof`agent was written as demonstration code for theJVM Tool Interface](http://docs.oracle.com/javase/8/docs/technotes/guides/jvmti/index.html)and not intended to be a production tool. The code and documentation contain a number of statements of the following form:

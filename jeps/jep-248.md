...
| Effort | M | 
| Duration | M | 
| Relates to | JEP 523: Make G1 the Default Garbage Collector in All Environments](523) | 
| Reviewed by | Mikael Vidstedt | 
| Endorsed by | Mikael Vidstedt | 
| Created | 2015/02/16 19:58 | 
| Updated | 2025/09/09 17:33 | 
| Issue | 8073273](https://bugs.openjdk.org/browse/JDK-8073273) | 
...
Many performance improvements were made to G1 in JDK 8 and its update releases, and further improvements are planned for JDK 9. The introduction of concurrent class unloading (JEP 156](http://openjdk.java.net/jeps/156)) in JDK 8u40 made G1 a fully-featured garbage collector, ready to be the default.

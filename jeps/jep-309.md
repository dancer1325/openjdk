...
| Effort | M | 
| Duration | M | 
| Relates to | JEP 303: Intrinsics for the LDC and INVOKEDYNAMIC Instructions](303) | 
| Reviewed by | Mark Reinhold | 
| Endorsed by | Mark Reinhold | 
| Created | 2017/03/20 20:26 | 
| Updated | 2018/09/10 18:57 | 
| Issue | 8177279](https://bugs.openjdk.org/browse/JDK-8177279) | 
...
This work requires some prototyping of JDK library support for a representative sample of a few kinds of constant types, notably variable handles(JEP 193)](193). In support of such prototyping, this work will coordinate with other work on basic language support for constant expressions (JEP 303](303)).
...
The draft Java Virtual Machine specification for`CONSTANT_Dynamic`can be found inJDK-8189199](https://bugs.openjdk.java.net/browse/JDK-8189199), the CSR issue associated with the main development issue of this JEP.
...
A discussion of design choices can be found inJDK-8161256](https://bugs.openjdk.java.net/browse/JDK-8161256), which deals with a number of related RFEs. The present JEP was distilled from this larger list of features.

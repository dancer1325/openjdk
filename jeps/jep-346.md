...
| Updated | 2023/10/09 20:39 | 
| Issue | 8204089](https://bugs.openjdk.org/browse/JDK-8204089) | 
...
Shenandoah](http://mail.openjdk.java.net/pipermail/hotspot-gc-dev/2018-June/022203.html)and OpenJ9'sGenCon collector](https://dzone.com/storage/assets/9318874-dzone2018-researchguide-java.pdf)already provide similar functionality.

Tests with a prototype inBruno et al., section 5.5](http://www.gsd.inesc-id.pt/~rbruno/publications/rbruno-ismm18.pdf), shows that based on the real-world utilization of a Tomcat server that serves HTTP requests during the day, and is mostly idle during the night, this solution can reduce the amount of memory committed by the Java VM by 85%.

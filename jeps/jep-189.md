...
| Issue | 8046179](https://bugs.openjdk.org/browse/JDK-8046179) | 
...
The Shenandoah algorithm is described in depth inthis PPPJ2016 paper](https://www.researchgate.net/publication/306112816_Shenandoah_An_open-source_concurrent_compacting_garbage_collector_for_OpenJDK).

Shenandoah has been implemented and will be supported by Red Hat for aarch64 and for amd64.

The on-going development for Shenandoah is done in the OpenJDKShenandoah](http://openjdk.java.net/projects/shenandoah/)project. See more details on current development flow, implementation details, availability atShenandoah wiki page](https://wiki.openjdk.java.net/display/shenandoah/Main).
...
Please see theShenandoah wiki page](https://wiki.openjdk.java.net/display/shenandoah/Main)for more information on how to setup and tune Shenandoah GC.

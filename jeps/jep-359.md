...
| Effort | M | 
| Duration | M | 
| Relates to | JEP 384: Records (Second Preview)](384) | 
|  | JEP 395: Records](395) | 
| Reviewed by | Alex Buckley | 
| Created | 2019/04/19 19:30 | 
| Updated | 2021/08/28 00:18 | 
| Issue | 8222777](https://bugs.openjdk.org/browse/JDK-8222777) | 

## Summary

Enhance the Java programming language withrecords](http://cr.openjdk.java.net/~briangoetz/amber/datum.html). Records provide a compact syntax for declaring classes which are transparent holders for shallowly immutable data. This is apreview language feature](http://openjdk.java.net/jeps/12)in JDK 14.

...
| Issue | 8227446](https://bugs.openjdk.org/browse/JDK-8227446) | 
...
The foreign memory API should be a valid alternative to the main avenues by which Java programs access foreign memory today, namely`java.nio.ByteBuffer`](https://docs.oracle.com/en/java/javase/13/docs/api/java.base/java/nio/ByteBuffer.html)and`sun.misc.Unsafe`](https://hg.openjdk.java.net/jdk/jdk/file/tip/src/jdk.unsupported/share/classes/sun/misc/Unsafe.java). The new API should be performance-competitive with these existing APIs.

## Motivation

Many existing Java libraries and programs access foreign memory, for exampleIgnite](https://apacheignite.readme.io/v1.0/docs/off-heap-memory),mapDB](http://www.mapdb.org/),memcached](https://github.com/dustin/java-memcached-client), and Netty'sByteBuf](https://netty.io/wiki/using-as-a-generic-library.html)API. By doing so they can

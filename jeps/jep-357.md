...
| Effort | L | 
| Duration | M | 
| Relates to | JEP 369: Migrate to GitHub](369) | 
| Reviewed by | Mark Reinhold | 
| Endorsed by | Mark Reinhold | 
| Created | 2019/07/12 02:20 | 
| Updated | 2021/01/27 21:56 | 
| Issue | 8227614](https://bugs.openjdk.org/browse/JDK-8227614) | 
...
- Port thejcheck](https://openjdk.java.net/projects/code-tools/jcheck/),webrev](https://openjdk.java.net/projects/code-tools/webrev/), anddefpath](http://openjdk.java.net/projects/code-tools/defpath/)tools to Git
- Create a tool to translate between Mercurial and Git hashes

## Non-Goals

- 
We will not migrate multi-repository OpenJDK Projects, such as theJDK 8 Updates Project](https://openjdk.java.net/projects/jdk8u). Those Projects can migrate to Git if and when theyconsolidate](https://openjdk.java.net/jeps/296)into a single repository.

- 
We will not change the bug system fromJBS](https://bugs.openjdk.java.net/).
...
- 
This JEP does not address the question of whether OpenJDK Git repositories will be self-hosted or hosted by an external provider. That issue is the topic ofJEP 369: Migrate to GitHub](https://openjdk.java.net/jeps/369).
...
- 
All text editors have Git integration, either natively or in the form of plugins includingEmacs](https://www.gnu.org/software/emacs/)(magit](https://magit.vc/)plugin),Vim](https://www.vim.org/)(fugitive.git](https://github.com/tpope/vim-fugitive)plugin),VS Code](https://code.visualstudio.com/)(builtin), andAtom](https://atom.io/)(builtin).

- 
Almost all integrated development environments (IDEs) also ship with Git integration out-of-the-box, includingIntelliJ](https://www.jetbrains.com/idea/)(builtin),Eclipse](https://eclipse.org/)(builtin),NetBeans](https://netbeans.org/)(builtin), andVisual Studio](https://visualstudio.microsoft.com/)(builtin).
...
- 
The Git ecosystem recognizes*trailers*, i.e., lines separated from the body with a newline. For example, bothGitHub](https://github.com/)andGitLab](https://gitlab.com/)recognizes the`Co-authored-by:`trailer and will recognize that the commit has multiple authors.
...
The content of the author and committer fields will be of the form*Real-name*`<`*Email*`>`, since not every commit author will be anOpenJDK Author](https://openjdk.java.net/bylaws#author). A special email address will be used to show that an author or committer is also an OpenJDK Author:`<openjdk-username>@openjdk.org`.
...
Examples of converted repositories are available athttps://github.com/openjdk/](https://github.com/openjdk/).

### Tools

We've already prototyped backward compatible ports of the Mercurial toolsjcheck](https://openjdk.java.net/projects/code-tools/jcheck/),webrev](https://openjdk.java.net/projects/code-tools/webrev/)anddefpath](http://openjdk.java.net/projects/code-tools/defpath/).

...
| Effort | M | 
| Duration | S | 
| Blocks | JEP 391: macOS/AArch64 Port](391) | 
| Reviewed by | Vladimir Kozlov | 
| Endorsed by | Mark Reinhold, Vladimir Kozlov | 
| Created | 2020/06/29 19:13 | 
| Updated | 2024/07/26 14:26 | 
| Issue | 8248496](https://bugs.openjdk.org/browse/JDK-8248496) | 
...
Early-access binaries are availablehere](https://github.com/microsoft/openjdk-aarch64).

## Testing

We have done thorough functional, performance, and regression testing on AArch64 test systems including Ampere eMAG1s, Marvell ThunderX2s (with SMT both on and off), and Surface Pro Xs. Our test suites include JTReg, JCStress, jmh-jdk-microbenchmarks, JFC applications and applets (demo/jfc), SPECJBB2005, SPECJBB2015, SPEC SERT, SPECJVM2008, DaCapo, and a few smaller benchmarks. Two of the test matrices are documented in detail:JTReg](https://github.com/microsoft/openjdk-aarch64/blob/master/JTRegtests.md)andSPECJBB2015](https://github.com/microsoft/openjdk-aarch64/blob/master/SPECJBB2015-test-matrices.md).
...
- 
We have made changes to shared code in the Linux/AArch64 backend to extend LP64 (64-bit long ints and pointers) to accommodate thelong-long ints and pointers (LLP64)](https://en.wikipedia.org/wiki/64-bit_computing#64-bit_data_models)needed by the 64-bit Windows platform.

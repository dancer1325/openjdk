...
| Issue | 8068562](https://bugs.openjdk.org/browse/JDK-8068562) | 
...
- API Notes –`@apiNote`
- Implementation Specification –`@implSpec`
- Implementation Notes –`@implNote`
...
The standard doclet needed to be enhanced to support the @inheritDoc tag in the desired way. SeeJDK-8008768](https://bugs.openjdk.java.net/browse/JDK-8008768).
...
Theinitial proposal](http://mail.openjdk.java.net/pipermail/lambda-libs-spec-experts/2013-January/001211.html)was discussed on the JSR-335 (Lambda Libraries) Expert Group mailing list. The discussion continued into February, with messages having the Subject line, "Javadoc conventions in the presence of default methods."

The implementation changes to support these new custom tags are covered by bugJDK-8008632](https://bugs.openjdk.java.net/browse/JDK-8008632).

The implementation changes necessary to support the new @inheritDoc model are covered by bugJDK-8008768](https://bugs.openjdk.java.net/browse/JDK-8008768).

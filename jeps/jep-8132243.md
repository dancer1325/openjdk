...
| Effort | M | 
| Duration | M | 
| Created | 2015/07/23 13:16 | 
| Updated | 2024/06/21 23:12 | 
| Issue | 8132243](https://bugs.openjdk.org/browse/JDK-8132243) | 
...
- 
silently`nullify`(ignore and discard) illegal stores to final fields;
...
- 
an alternative`sun.misc.Unsafe`implementation which detects final field updates and performs a "slushy" bit check can be implemented.

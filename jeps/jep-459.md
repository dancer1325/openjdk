...
| Effort | M | 
| Duration | M | 
| Relates to | JEP 430: String Templates (Preview)](430) | 
|  | JEP 465: String Templates (Third Preview)](465) | 
|  | 8318909: JEP 459: JLS Changes for String Templates (Second Preview)](https://bugs.openjdk.org/browse/JDK-8318909) | 
| Reviewed by | Alex Buckley, Gavin Bierman | 
| Endorsed by | Brian Goetz | 
| Created | 2023/08/14 12:17 | 
| Updated | 2025/02/25 16:31 | 
| Issue | 8314219](https://bugs.openjdk.org/browse/JDK-8314219) | 

## Summary

Enhance the Java programming language with*string templates*. String templates complement Java's existing string literals and text blocks by coupling literal text with embedded expressions and*template processors*to produce specialized results. This is apreview language feature and API](https://openjdk.org/jeps/12).

## History

String Templates were originally proposed as a preview feature byJEP 430](https://openjdk.org/jeps/430)in JDK 21. We here propose a second preview in order to gain additional experience and feedback. Except for a technical change in the types of template expressions, there are no changes relative to the first preview.

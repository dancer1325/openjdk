...
| Created | 2012/11/21 20:00 | 
| Updated | 2015/02/13 19:38 | 
| Issue | 8046164](https://bugs.openjdk.org/browse/JDK-8046164) | 
...
- 
Nashorn will only support ECMAScript-262 Edition 5.1. It will not support any features of Edition 6, or any non-standard features provided by other JavaScript implementations.
...
- test262](http://test262.ecmascript.org)(ecmascript.org)
- ES5conform](http://es5conform.codeplex.com/)
...
- 
Sunspider](http://www.webkit.org/perf/sunspider/sunspider.html)JavaScript core engine performance tests (webkit.org)

- 
v8 (Octane) performance tests](http://v8.googlecode.com/svn/data/benchmarks/v6/run.html)

There has been some adaptation work to run these tests under the Nashorn test framework.

Note: These performance tests do not include browser API access (DOM/CSS,*et al*.) Performance test suites such asDromaeo](http://v2.dromaeo.com)do provide such tests, but they are beyond the current scope of Nashorn.

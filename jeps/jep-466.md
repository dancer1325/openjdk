...
| Effort | S | 
| Duration | M | 
| Relates to | JEP 457: Class-File API (Preview)](457) | 
...
| Issue | 8324965](https://bugs.openjdk.org/browse/JDK-8324965) | 
...
We have adopted the following design goals and principles for theClass-File API](https://docs.oracle.com/en/java/javase/23/docs/api/java.base/java/lang/classfile/package-summary.html).
...
- 
When using thesource code launcher](https://openjdk.org/jeps/330), run the program with`java --enable-preview Main.java`

...
| Updated | 2020/09/14 16:11 | 
| Issue | 8218559](https://bugs.openjdk.org/browse/JDK-8218559) | 

## Summary

Replace the underlying implementation used by the`java.net.Socket`and`java.net.ServerSocket`APIs with a simpler and more modern implementation that is easy to maintain and debug. The new implementation will be easy to adapt to work with user-mode threads, a.k.a. fibers, currently being explored inProject Loom](https://openjdk.java.net/projects/loom).

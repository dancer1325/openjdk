...
| Effort | XS | 
| Duration | XS | 
| Relates to | JEP 448: Vector API (Sixth Incubator)](448) | 
|  | JEP 469: Vector API (Eighth Incubator)](469) | 
| Reviewed by | Vladimir Ivanov | 
| Endorsed by | John Rose | 
| Created | 2023/09/08 17:29 | 
| Updated | 2025/02/25 16:34 | 
| Issue | 8315945](https://bugs.openjdk.org/browse/JDK-8315945) | 
...
The Vector API was first proposed byJEP 338](https://openjdk.org/jeps/338)and integrated into JDK 16 as anincubating API](https://openjdk.org/jeps/11). Further rounds of incubation were proposed byJEP 414](https://openjdk.org/jeps/414)(integrated into JDK 17),JEP 417](https://openjdk.org/jeps/417)(JDK 18),JEP 426](https://openjdk.org/jeps/426)(JDK 19),JEP 438](https://openjdk.org/jeps/438)(JDK 20), andJEP 448](https://openjdk.org/jeps/448)(JDK 21).
...
- Support vector access with heap`MemorySegment`s that are backed by an array of any primitive element type. Previously access was limited to heap`MemorySegment`s backed by an array of byte.

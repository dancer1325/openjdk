...
| Effort | L | 
| Duration | XL | 
| Relates to | JEP 192: String Deduplication in G1](192) | 
|  | 8144691: JEP 254: Compact Strings: endiannes mismatch in Java source code and intrinsic](https://bugs.openjdk.org/browse/JDK-8144691) | 
|  | JEP 250: Store Interned Strings in CDS Archives](250) | 
|  | JEP 280: Indify String Concatenation](280) | 
| Reviewed by | Aleksey Shipilev, Brian Goetz, Charlie Hunt | 
| Endorsed by | Brian Goetz | 
| Created | 2014/08/04 21:54 | 
| Updated | 2025/07/23 10:59 | 
| Issue | 8054307](https://bugs.openjdk.org/browse/JDK-8054307) | 
...
Other recent projects have already reduced the heap space used by strings, in particularJEP 192: String Deduplication in G1](http://openjdk.java.net/jeps/192). Even with duplicates eliminated, the remaining string data can be made to consume less space if encoded more efficiently. We are assuming that this project will still provide a benefit commensurate with the effort required.
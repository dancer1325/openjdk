...
| Created | 2014/06/02 17:15 | 
| Updated | 2017/03/08 23:38 | 
| Issue | 8044552](https://bugs.openjdk.org/browse/JDK-8044552) | 
...
Here](http://cr.openjdk.java.net/~aph/aarch64.1)is a patch of the changes needed to the shared code in HotSpot.

All changesets are collected in a staging repository:http://hg.openjdk.java.net/aarch64-port/stage/](http://hg.openjdk.java.net/aarch64-port/stage/)

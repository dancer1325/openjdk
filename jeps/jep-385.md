...
| Effort | XS | 
| Duration | XS | 
| Relates to | JEP 407: Remove RMI Activation](407) | 
| Reviewed by | Alan Bateman, Roger Riggs | 
| Endorsed by | Brian Goetz | 
| Created | 2020/05/13 02:43 | 
| Updated | 2021/08/28 00:23 | 
| Issue | 8244917](https://bugs.openjdk.org/browse/JDK-8244917) | 

## Summary

Deprecate theRMI Activation](https://docs.oracle.com/en/java/javase/14/docs/specs/rmi/activation.html)mechanism for future removal. RMI Activation is an obsolete part of RMI that has been optional since Java 8. No other part of RMI will be deprecated.
...
RMI Activation was made optional inJava 8](https://docs.oracle.com/javase/8/docs/api/java/rmi/activation/package-summary.html#package.description). There were no objections to on this specification change, nor have there been any bug reports concerning the optionality of Activation.
...
- 
Add`@Deprecated(forRemoval=true)`to all public classes and interfaces that reside in thejava.rmi.activation](https://docs.oracle.com/en/java/javase/14/docs/api/java.rmi/java/rmi/activation/package-summary.html)package.

- 
Add a`@deprecated`javadoc tag and explanation to the`java.rmi.activation`package declaration.

- 
Add a notice of deprecation of Activation to thejava.rmi](https://docs.oracle.com/en/java/javase/14/docs/api/java.rmi/module-summary.html)module specification.

- 
Add a notice of deprecation to theRMI Activation](https://docs.oracle.com/en/java/javase/14/docs/specs/rmi/activation.html)chapter of the RMI Specification.
...
- 
Change thermid](https://docs.oracle.com/en/java/javase/14/docs/specs/man/rmid.html)tool to emit a warning message about deprecation.

- 
Add warning notices to thermid tool documentation page](https://docs.oracle.com/en/java/javase/14/docs/specs/man/rmid.html). This will include notice of deprecation of the`rmid`tool itself. It will also include notice of deprecation of the permission classes in`com.sun.rmi.rmid`, since this page appears to be the only place in the JDK where these permission classes are documented.

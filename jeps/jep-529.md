...
| Effort | XS | 
| Duration | XS | 
| Relates to | JEP 508: Vector API (Tenth Incubator)](508) | 
| Reviewed by | Emanuel Peter, Jatin Bhateja, Paul Sandoz | 
| Endorsed by | Paul Sandoz | 
| Created | 2025/10/01 16:43 | 
| Updated | 2025/11/13 19:53 | 
| Issue | 8369012](https://bugs.openjdk.org/browse/JDK-8369012) | 
...
We first proposed the Vector API inJEP 338](https://openjdk.org/jeps/338)and integrated it into JDK 16 as anincubating API](https://openjdk.org/jeps/11). We proposed further rounds of incubation inJEP 414](https://openjdk.org/jeps/414)(integrated into JDK 17),JEP 417](https://openjdk.org/jeps/417)(JDK 18),JEP 426](https://openjdk.org/jeps/426)(JDK 19),JEP 438](https://openjdk.org/jeps/438)(JDK 20),JEP 448](https://openjdk.org/jeps/448)(JDK 21),JEP 460](https://openjdk.org/jeps/460)(JDK 22),JEP 469](https://openjdk.org/jeps/469)(JDK 23),JEP 489](https://openjdk.org/jeps/489)(JDK 24), andJEP 508](https://openjdk.org/jeps/508)(JDK 25),

We here propose to re-incubate the Vector API in JDK 26 without substantial change.

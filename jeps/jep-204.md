...
| Author | Stephen Northover | 
| Owner | Steve Northover | 
| Type | Feature | 
| Scope | JDK | 
...
| Effort | XL | 
| Duration | XL | 
| Relates to | JEP 209: JavaFX Scene Builder Update](209) | 
| Reviewed by | Kevin Rushforth | 
| Endorsed by | Richard Bair | 
| Created | 2014/05/16 18:55 | 
| Updated | 2016/06/07 23:34 | 
| Issue | 8043344](https://bugs.openjdk.org/browse/JDK-8043344) | 
...
The following links describe a very early prototype that is already in progress:Keyboard navigation](https://wiki.openjdk.java.net/display/OpenJFX/Keyboard+Navigation),accessibility exploration](https://wiki.openjdk.java.net/display/OpenJFX/Accessibility+Exploration).

...
| Effort | M | 
| Duration | M | 
| Relates to | JEP 326: Raw String Literals (Preview)](326) | 
...
| Issue | 8222530](https://bugs.openjdk.org/browse/JDK-8222530) | 

## Summary

Add*text blocks*to the Java language. A text block is a multi-line string literal that avoids the need for most escape sequences, automatically formats the string in a predictable way, and gives the developer control over format when desired. This is apreview language feature](http://openjdk.java.net/jeps/12)in JDK 13.

## History

This is a follow-on effort to explorations begun inJEP 326](https://openjdk.java.net/jeps/326)(Raw String Literals), which waswithdrawn](https://mail.openjdk.java.net/pipermail/jdk-dev/2018-December/002402.html)and did not appear in JDK 12.
...
It is not possible to opt out of trailing white space removal, so in rare contexts where trailing white space is significant (such astwo spaces for a`<br />`tag in Markdown](https://daringfireball.net/projects/markdown/syntax#p)), developers must resort to unusual measures to force its inclusion, such as theoctal escape sequence](https://docs.oracle.com/javase/specs/jls/se12/html/jls-3.html#jls-3.10.6)`\040`(ASCII character 32, white space):

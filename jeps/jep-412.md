...
| Reviewed by | Adam Pocock, Alex Buckley, Paul Sandoz | 
| Created | 2021/04/10 21:05 | 
| Updated | 2022/03/02 17:11 | 
| Issue | 8265033](https://bugs.openjdk.org/browse/JDK-8265033) | 
...
The API proposed in this JEP is the evolution of two incubating APIs: the Foreign-Memory Access API and the Foreign Linker API. The Foreign-Memory Access API was first proposed byJEP 370](https://openjdk.java.net/jeps/370)and targeted to Java 14 in late 2019 as anincubating API](https://openjdk.java.net/jeps/11); it was re-incubated byJEP 383](https://openjdk.java.net/jeps/383)in Java 15 and byJEP 393](https://openjdk.java.net/jeps/393)in Java 16. The Foreign Linker API was first proposed byJEP 389](https://openjdk.java.net/jeps/389)and targeted to Java 16 in late 2020, also as anincubating API](https://openjdk.java.net/jeps/11).
...
(`MemoryLayout`,`MemoryHandles`, and`MemoryAccess`),

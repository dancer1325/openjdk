...
| Effort | XS | 
| Duration | S | 
| Depends | JEP 162: Prepare for Modularization](162) | 
| Reviewed by | Alan Bateman | 
| Endorsed by | Mark Reinhold | 
| Created | 2013/03/13 20:00 | 
| Updated | 2014/11/03 23:58 | 
| Issue | 8046169](https://bugs.openjdk.org/browse/JDK-8046169) | 
...
This feature builds on the investigations conducted forJEP 162,*Prepare for Modularization*](https://bugs.openjdk.org/browse/JDK-8046152).

## Impact

- 
Other JDK components: The concepts used for the annotations of this proposal may help formalize policies in other parts of the JDK, but the effort is focused on helping to manage the non-Java SE APIs.

- 
Compatibility: The feature will allow compatibility policies to be better documented and enforced.

- 
Documentation: The new annotations will be`@Documented`and thus be included as part of any generated javadoc bundles.

- 
TCK: Since this proposal is outside of Java SE, there is no TCK impact.
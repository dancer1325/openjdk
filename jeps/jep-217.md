...
| Effort | L | 
| Duration | L | 
| Relates to | JEP 215: Tiered Attribution for javac](215) | 
| Reviewed by | Alex Buckley, Jonathan Gibbons, Maurizio Cimadamore | 
| Endorsed by | Brian Goetz | 
| Created | 2014/06/23 21:29 | 
| Updated | 2016/07/12 21:03 | 
| Issue | 8047926](https://bugs.openjdk.org/browse/JDK-8047926) | 
...
- 
TheCheckers Framework](http://types.cs.washington.edu/checker-framework/)must continue to work.
...
Java SE 8 introduced two new annotation features,Repeating Annotations (JEP 120)](http://openjdk.java.net/jeps/120)andAnnotations on Java Types (JSR 308 / JEP 104)](http://openjdk.java.net/jeps/104). In additionLambda Expressions (JSR 335 / JEP 126)](http://openjdk.java.net/jeps/126)added new syntactic position for annotations. These features, none of which existed when the`javac`annotation pipeline was initially conceived, can be combined together, leading to patterns such as:

...
| Effort | L | 
| Duration | L | 
| Blocks | JEP 351: ZGC: Uncommit Unused Memory (Experimental)](351) | 
|  | JEP 364: ZGC on macOS (Experimental)](364) | 
|  | JEP 365: ZGC on Windows (Experimental)](365) | 
| Depends | JEP 312: Thread-Local Handshakes](312) | 
|  | JEP 304: Garbage Collector Interface](304) | 
...
| Issue | 8197831](https://bugs.openjdk.org/browse/JDK-8197831) | 
...
Please see theZGC Project Wiki](https://wiki.openjdk.java.net/display/zgc/Main)for more information on how to setup and tune ZGC.
...
- 
A theoretical alternative would be to improve CMS one way or another. There are however several reasons why basing a low latency collector on the CMS algorithm is neither an attractive nor viable option. Reasons include no support for compaction, the unbound remark phase, a complicated code base, and the fact that it has already been deprecated (JEP 291](http://openjdk.java.net/jeps/291)).

- 
The Shenandoah Project is exploring the use of Brooks pointers to achieve concurrent operations (JEP 189](http://openjdk.java.net/jeps/189)).

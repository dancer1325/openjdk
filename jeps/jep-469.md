...
| Effort | XS | 
| Duration | XS | 
| Relates to | JEP 460: Vector API (Seventh Incubator)](460) | 
...
| Issue | 8326878](https://bugs.openjdk.org/browse/JDK-8326878) | 
...
The Vector API will incubate until necessary features of Project Valhalla become available aspreview features](https://openjdk.org/jeps/12). At that time, we will adapt the Vector API and its implementation to use them, and will promote the Vector API from incubation to preview.

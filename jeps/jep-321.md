...
|  | JEP 517: HTTP/3 for the HTTP Client API](517) | 
| Reviewed by | Alan Bateman, Brian Goetz | 
| Endorsed by | Brian Goetz | 
| Created | 2017/06/08 11:46 | 
| Updated | 2024/08/27 14:42 | 
| Issue | 8181784](https://bugs.openjdk.org/browse/JDK-8181784) | 

## Summary

Standardize theincubated](http://openjdk.java.net/jeps/11)HTTP Client API introduced in JDK 9, viaJEP 110](http://openjdk.java.net/jeps/110), and updated in JDK 10.

## Goals

In addition to thegoals of JEP 110](http://openjdk.java.net/jeps/110#Goals), this JEP will:
...
- 
The predefined implementation of`BodyPublisher`,`BodyHandler`, and`BodySubscriber`, created through static factory methods, have been moved out to separate non-instantiable utility factory classes, following the pluralized naming convention. This improves readability of these relatively small interfaces.

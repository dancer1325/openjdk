...
| Effort | L | 
| Duration | L | 
| Relates to | JEP 158: Unified JVM Logging](158) | 
| Reviewed by | Mikael Vidstedt | 
| Endorsed by | Mikael Vidstedt | 
| Created | 2014/10/06 21:19 | 
| Updated | 2017/06/02 19:18 | 
| Issue | 8059805](https://bugs.openjdk.org/browse/JDK-8059805) | 

## Summary

Reimplement GC logging using the unified JVM logging framework introduced inJEP 158](http://openjdk.java.net/jeps/158).
